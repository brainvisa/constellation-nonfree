...
from constel.lib.meshwatershedtools import watershedWithBasinsMerging
...
def main():
    ...
    print "Computing watershed and regrouping of parcells according to size and depth values..."
