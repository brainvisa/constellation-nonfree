...
namespace constel {
  ...
  Graph * texMeshAndBundles_to_BundlesGraph( const AimsSurfaceTriangle & inAimsMesh, carto::rc_ptr<TimeTexture<short> > tex, std::string namesMode, std::string bundlesFile_name, Motion motion, const std::string & BundlesNamesfile_name = std::string() );
