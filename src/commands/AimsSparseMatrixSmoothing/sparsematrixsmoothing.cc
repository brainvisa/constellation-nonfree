...
int main( int argc, const char** argv )
{
  ...
  AimsApplication app( argc, argv, "Sparse matrix smoothing using heat diffusion, with the geometry of a mesh. Can typically be used for connectivity matrix smoothing. Smoothing is applied for each line." );
  ...
  app.addOption( threshold, "-t", "threshold smoothing coefficients under this value (default: 0.0001)", true );
